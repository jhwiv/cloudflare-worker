...
const ITINERARY_SCHEDULE = {
  ...
  wwii2026: [
    // 15-day London / Normandy / Nuremberg / Porto trip, Oct 12-26 2026.
    // Rebuilt 2026-08-18 to match aripshitadventure.com's rebuilt itinerary
    // (new routesmith.ai PDF export; Nuremberg reinstated, London rewritten,
    // trip shifted 2 days later and extended to 14 nights). Segments are
    ...
    // JSON rather than inventing minute-level timings. Computed with Python
    // zoneinfo per the real IANA timezone for each day (not hand-typed UTC
    ...
    { from: '2026-10-16T23:00:00Z', to: '2026-10-17T22:00:00Z', city: 'London', timezone: 'Europe/London', lat: 51.5074, lng: -0.1278, note: 'Day 6: Thames river cruise, then the Disastrous London walking tour' },
    { from: '2026-10-17T22:00:00Z', to: '2026-10-18T22:00:00Z', city: 'Normandy', timezone: 'Europe/Paris', lat: 49.2764, lng: -0.7024, note: 'Day 7: Tiger tanks at Bovington, then drive into Normandy' },
    { from: '2026-10-18T22:00:00Z', to: '2026-10-19T22:00:00Z', city: 'Normandy', timezone: 'Europe/Paris', lat: 49.2764, lng: -0.7024, note: 'Day 8: Omaha Beach at dawn, then Pointe du Hoc and the American Cemetery' },
    { from: '2026-10-19T22:00:00Z', to: '2026-10-20T22:00:00Z', city: 'Nuremberg', timezone: 'Europe/Berlin', lat: 49.4521, lng: 11.0767, note: 'Day 9: Bayeux museum morning, then a long drive east to Nuremberg' },
    { from: '2026-10-20T22:00:00Z', to: '2026-10-21T23:00:00Z', city: 'Nuremberg', timezone: 'Europe/Berlin', lat: 49.4521, lng: 11.0767, note: 'Day 10: Courtroom 600, where the architects of the Holocaust stood trial' },
    { from: '2026-10-21T23:00:00Z', to: '2026-10-22T23:00:00Z', city: 'Porto', timezone: 'Europe/Lisbon', lat: 41.1579, lng: -8.6291, note: 'Day 11: Settle into Porto with a sunset walk along the Douro' },
...
- Do NOT fabricate place names, but DO use your real knowledge of well-known establishments in these areas.`;
  ...
  wwii2026: {
    ...
    buildPrompt: (wxSummary, locationNote, localTime, inferredLocation, nearbyPlacesContext) => {
      const timeLabel = inferredLocation?.city || 'local time';
      return `You are a knowledgeable, friendly travel concierge for a 15-day trip through London, Normandy, Nuremberg, and Porto (Oct 12-26, 2026), with a cultural WWII-history focus for the first three legs and a relaxed wine-country finish in Porto. You are embedded in the trip's guide website.
...
- Nuremberg's Memorium Nürnberger Prozesse (Courtroom 600) can close unpredictably when a real court session is scheduled there — it's booked for Day 10 (Wednesday), and the plan itself flags calling +49 911 3217 9372 one to two days ahead to confirm it's open that day. If the traveler asks about it, mention that confirmation call rather than assuming the visit is guaranteed.

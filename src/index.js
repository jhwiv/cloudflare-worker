...
const ITINERARY_SCHEDULE = {
  ...
  wwii2026: [
    // 15-day London / Normandy / Porto trip, Oct 12-26 2026.
    // Rebuilt 2026-08-21 to match aripshitadventure.com's revert of its
    // 2026-08-18 rebuild - the traveler confirmed directly that Nuremberg
    // should not be in this itinerary at all, and that the Portsmouth-
    // Ouistreham ferry crossing is a genuine overnight sailing (departs
    // 22:45, docks ~07:45), not a same-day arrival. Segments are
    // calendar-day (local midnight-to-midnight) rather than precise clock
    // times, matching each day's own `city` field from the verified plan
    // JSON rather than inventing minute-level timings - Day 7 stays
    // 'London' for its full calendar day since the ferry doesn't dock in
    // Normandy until the morning of Day 8. Computed with Python zoneinfo
    // per the real IANA timezone for each day (not hand-typed UTC
    // offsets), so the Oct 25 2026 EU/UK DST fall-back (BST->GMT, WEST->WET)
    // is handled automatically rather than needing a manual correction.
    // At a city-change boundary the two cities' local midnights land at
    // different UTC instants (they're on different UTC offsets), so a
    // segment's `to` is snapped to match the next segment's `from` exactly
    // (not its own city's true local midnight) - otherwise getItineraryLocation
    // sees either a 1h gap (returns null) or a 1h overlap (returns the wrong
    // city) right at the transition. Same-city consecutive days are unaffected.
    // Contiguity (from[i+1] === to[i] for every i) verified programmatically
    // when this was generated, not eyeballed.
    { from: '2026-10-12T04:00:00Z', to: '2026-10-12T23:00:00Z', city: 'Newark (departing)', timezone: 'America/New_York', lat: 40.6895, lng: -74.1745, note: 'Day 1: At/near EWR all day - Polaris lounge before the 9:00 PM overnight flight to Heathrow' },
    { from: '2026-10-12T23:00:00Z', to: '2026-10-13T23:00:00Z', city: 'London', timezone: 'Europe/London', lat: 51.5074, lng: -0.1278, note: 'Day 2: Land Heathrow, settle into the VRBO, sunset spin on the London Eye' },
    { from: '2026-10-13T23:00:00Z', to: '2026-10-14T23:00:00Z', city: 'London', timezone: 'Europe/London', lat: 51.5074, lng: -0.1278, note: 'Day 3: Stand in Churchill\'s map room, then Phantom of the Opera matinee' },
    { from: '2026-10-14T23:00:00Z', to: '2026-10-15T23:00:00Z', city: 'London', timezone: 'Europe/London', lat: 51.5074, lng: -0.1278, note: 'Day 4: Imperial War Museum, then the Kensington Royal Village walking tour' },
    { from: '2026-10-15T23:00:00Z', to: '2026-10-16T23:00:00Z', city: 'London', timezone: 'Europe/London', lat: 51.5074, lng: -0.1278, note: 'Day 5: The windowless Battle of Britain Bunker, Kiln for dinner, then Hamilton' },
    { from: '2026-10-16T23:00:00Z', to: '2026-10-17T23:00:00Z', city: 'London', timezone: 'Europe/London', lat: 51.5074, lng: -0.1278, note: 'Day 6: Thames river cruise, then the Disastrous London walking tour' },
    { from: '2026-10-17T23:00:00Z', to: '2026-10-18T22:00:00Z', city: 'London', timezone: 'Europe/London', lat: 51.5074, lng: -0.1278, note: 'Day 7: Tiger tanks at Bovington, then an overnight Brittany Ferries crossing to Normandy' },
    { from: '2026-10-18T22:00:00Z', to: '2026-10-19T22:00:00Z', city: 'Normandy', timezone: 'Europe/Paris', lat: 49.2764, lng: -0.7024, note: 'Day 8: Ferry docks at dawn, then Omaha Beach and the American Cemetery' },
    { from: '2026-10-19T22:00:00Z', to: '2026-10-20T22:00:00Z', city: 'Normandy', timezone: 'Europe/Paris', lat: 49.2764, lng: -0.7024, note: 'Day 9: Self-guided day in Bayeux - the cathedral and the old town' },
    { from: '2026-10-20T22:00:00Z', to: '2026-10-21T23:00:00Z', city: 'Normandy', timezone: 'Europe/Paris', lat: 49.2764, lng: -0.7024, note: 'Day 10: Full-day trip to Mont-Saint-Michel' },
    { from: '2026-10-21T23:00:00Z', to: '2026-10-22T23:00:00Z', city: 'Porto', timezone: 'Europe/Lisbon', lat: 41.1579, lng: -8.6291, note: 'Day 11: Drive to Paris CDG, fly to Porto, settle in with a Ribeira waterfront walk' },
    { from: '2026-10-22T23:00:00Z', to: '2026-10-23T23:00:00Z', city: 'Porto', timezone: 'Europe/Lisbon', lat: 41.1579, lng: -8.6291, note: 'Day 12: Morning port tasting at Graham\'s Lodge, afternoon at Sao Bento Station' },
    { from: '2026-10-23T23:00:00Z', to: '2026-10-24T23:00:00Z', city: 'Porto', timezone: 'Europe/Lisbon', lat: 41.1579, lng: -8.6291, note: 'Day 13: Private Douro Valley day - Quinta do Vallado tasting & river lunch' },
    { from: '2026-10-24T23:00:00Z', to: '2026-10-26T00:00:00Z', city: 'Porto', timezone: 'Europe/Lisbon', lat: 41.1579, lng: -8.6291, note: 'Day 14: Livraria Lello, then Clerigos Tower at sunset for a farewell dinner' },
    { from: '2026-10-26T00:00:00Z', to: '2026-10-27T00:00:00Z', city: 'Porto', timezone: 'Europe/Lisbon', lat: 41.1579, lng: -8.6291, note: 'Day 15: Morning coffee in Ribeira, then home' },
  ],
  maritimes: [
...
- Do NOT fabricate place names, but DO use your real knowledge of well-known establishments in these areas.`;
  ...
  wwii2026: {
    ...
    defaultGeoNote: 'They are NOT currently near London, Normandy, or Porto — they may be planning ahead.',
    localTimezone: 'Europe/London',
    buildPrompt: (wxSummary, locationNote, localTime, inferredLocation, nearbyPlacesContext) => {
      const timeLabel = inferredLocation?.city || 'local time';
      return `You are a knowledgeable, friendly travel concierge for a 15-day trip through London, Normandy, and Porto (Oct 12-26, 2026), with a cultural WWII-history focus for the first two legs and a relaxed wine-country finish in Porto. You are embedded in the trip's guide website.
...
- For the WWII sites (Churchill War Rooms, IWM, the Normandy beaches), give context that helps the visit land, not just logistics.
- Reference restaurants by name and the day they're booked.
- Day 7 into Day 8 is an overnight Brittany Ferries crossing (Portsmouth → Ouistreham, departs 22:45, docks ~07:45) — if the traveler asks about that night, they're on the ferry, not in a hotel.
...
// ── WWII2026 ITINERARY (London / Normandy / Porto) ─────────
const WWII_ITINERARY = `{"trip":{"title":"London → Normandy → Porto · October 2026","dates":"Oct 12-26, 2026 (14 nights)","travelers":"2 adults","theme":"Cultural WWII focus + Porto finish"},"hotels":[{"city":"London","nights":5,"name":"VRBO rental (not yet booked)","nightsOnDays":"Day 2-6 (5 nights, checkout morning of Day 7)"},{"city":"Normandy","nights":3,"name":"VRBO or boutique hotel (not yet booked), Bayeux area","nightsOnDays":"Day 8-10 (3 nights, checkout morning of Day 11 - Day 11 is spent flying to Porto via Paris CDG)"},{"city":"Porto","nights":4,"name":"VRBO rental (not yet booked), Ribeira district","nightsOnDays":"Day 11-14 (4 nights, checkout morning of Day 15)"}],"days":[{"day":1,"label":"Day 1 · Mon Oct 12 · Depart Newark","city":"Newark (departing)","headline":"Overnight flight to Heathrow — Polaris lounge before wheels up","stops":[{"time":"21:00","type":"Flight","text":"Newark (EWR) to London Heathrow (LHR) — nonstop overnight"}]},{"day":2,"label":"Day 2 · Tue Oct 13 · Arrive London","city":"London","headline":"Settle into the VRBO, then golden-hour spin on the London Eye","stops":[{"time":"09:20","type":"Flight","text":"Land Heathrow Terminal 2 — collect bags, clear immigration"},{"time":"11:00","type":"Transport","text":"Heathrow Express to Paddington, then Tube or Uber to VRBO — 60–75 min total"},{"time":"12:30","type":"Hotel","text":"Check in to VRBO rental — location TBD by traveler","hotel":"VRBO rental (traveler to book)"},{"time":"13:00","type":"Note","text":"Rest, unpack, neighborhood walk — no fixed agenda"},{"time":"17:30","type":"Activity","text":"London Eye — sunset rotation"},{"time":"19:30","type":"Dinner","text":"Hoppers — Sri Lankan, dosas & curries, walk-in","restaurant":"Hoppers"}]},{"day":3,"label":"Day 3 · Wed Oct 14 · Churchill War Rooms & Phantom Matinee","city":"London","headline":"Stand in Churchill's map room where the war was directed","stops":[{"time":"10:00","type":"Activity","text":"Churchill War Rooms — underground nerve center of WWII Britain"},{"time":"12:30","type":"Lunch","text":"The Cinnamon Club — modern Indian near Westminster","restaurant":"The Cinnamon Club"},{"time":"14:00","type":"Transport","text":"Tube or walk to His Majesty's Theatre — 20 min"},{"time":"14:30","type":"Activity","text":"Phantom of the Opera matinee — His Majesty's Theatre"},{"time":"18:00","type":"Note","text":"Free evening — rest at VRBO or explore Soho"},{"time":"19:30","type":"Dinner","text":"Smoking Goat — Thai BBQ, charcoal-grilled","restaurant":"Smoking Goat"}]},{"day":4,"label":"Day 4 · Thu Oct 15 · Imperial War Museum & Kensington Walk","city":"London","headline":"Stand beneath a Spitfire and a V-2 rocket in the atrium","stops":[{"time":"10:00","type":"Activity","text":"Imperial War Museum — WWII galleries, Holocaust exhibition, Spitfire atrium"},{"time":"13:00","type":"Lunch","text":"Regency Cafe — classic British greasy spoon near the museum","restaurant":"Regency Cafe"},{"time":"13:45","type":"Transport","text":"Tube: Pimlico -> High Street Kensington — 20 min"},{"time":"14:00","type":"Activity","text":"London Walks: Kensington Royal Village walking tour"},{"time":"16:30","type":"Note","text":"Free afternoon — return to VRBO or explore Kensington Gardens"},{"time":"19:30","type":"Dinner","text":"The Ledbury — three Michelin stars, Notting Hill","restaurant":"The Ledbury"}]},{"day":5,"label":"Day 5 · Fri Oct 16 · RAF Uxbridge, Kiln Dinner, Hamilton","city":"London","headline":"The windowless bunker where the Battle of Britain was won","stops":[{"time":"09:00","type":"Transport","text":"Tube + walk to RAF Uxbridge — 50 min via Piccadilly Line to Uxbridge, then 15 min walk"},{"time":"10:00","type":"Activity","text":"Battle of Britain Bunker (RAF Uxbridge Underground Operations Room)"},{"time":"13:00","type":"Transport","text":"Return to central London via Tube — 50 min"},{"time":"14:00","type":"Lunch","text":"Dishoom King's Cross — Bombay cafe, all-day menu","restaurant":"Dishoom King's Cross"},{"time":"15:00","type":"Note","text":"Return to VRBO, rest before evening"},{"time":"18:00","type":"Dinner","text":"Kiln — Northern Thai, wood-fired (user-requested)","restaurant":"Kiln"},{"time":"19:15","type":"Transport","text":"Walk to Victoria Palace Theatre — 15 min"},{"time":"19:30","type":"Activity","text":"Hamilton — Victoria Palace Theatre, 7:30 PM"}]},{"day":6,"label":"Day 6 · Sat Oct 17 · Thames Cruise & Disastrous London Walk","city":"London","headline":"Thames from Embankment, then walk Barbican's disaster sites","stops":[{"time":"10:00","type":"Activity","text":"Thames sightseeing river cruise from Embankment Pier"},{"time":"12:00","type":"Lunch","text":"Lunch at The Anchor Bankside","restaurant":"The Anchor Bankside"},{"time":"13:30","type":"Transport","text":"Tube to Barbican Station"},{"time":"14:30","type":"Activity","text":"London Walks: Disastrous London walk departing Barbican Station"},{"time":"17:00","type":"Note","text":"Free evening"},{"time":"19:30","type":"Dinner","text":"Dinner at Moro","restaurant":"Moro"}]},{"day":7,"label":"Day 7 · Sun Oct 18 · Tank Museum & Overnight Ferry to Normandy","city":"London","headline":"Bovington's Tiger 131, then an overnight Channel crossing straight into Normandy","stops":[{"time":"07:00","type":"Hotel","text":"Check out of VRBO rental"},{"time":"07:30","type":"Transport","text":"Pick up rental car and depart for Bovington"},{"time":"10:00","type":"Activity","text":"The Tank Museum, Bovington"},{"time":"12:45","type":"Lunch","text":"Lunch at The Tank Museum cafe or nearby Wool","restaurant":"Bovington Tank Museum Cafe"},{"time":"14:15","type":"Transport","text":"Drive Bovington to Portsmouth International Port — approx. 1h20m via A35/A31 (65 miles)"},{"time":"18:30","type":"Transport","text":"Check in for Brittany Ferries overnight sailing, Portsmouth -> Ouistreham (Caen) — boarding opens approx. 90 min before departure"},{"time":"20:00","type":"Dinner","text":"Dinner aboard the ferry — onboard restaurant"},{"time":"22:45","type":"Transport","text":"Ferry departs Portsmouth — overnight crossing, cabin booked, approx. 8 hrs — arrives Ouistreham (Caen) approx. 07:45 local time (Day 8)"}]},{"day":8,"label":"Day 8 · Mon Oct 19 · American Sector — Omaha & the Cemetery","city":"Normandy","headline":"Ferry docks at dawn, then Omaha Beach and the American Cemetery","stops":[{"time":"07:45","type":"Transport","text":"Ferry docks at Ouistreham (Caen) — French time (clocks forward 1h from UK)"},{"time":"08:05","type":"Transport","text":"Drive Ouistreham to the Omaha Beach area — approx. 45 min"},{"time":"08:30","type":"Activity","text":"Omaha Beach & D-Day landing sites (self-guided or private guide)"},{"time":"14:00","type":"Lunch","text":"Lunch at La Creperie du Vieux Chateau","restaurant":"La Creperie du Vieux Chateau"},{"time":"15:30","type":"Activity","text":"Normandy American Cemetery & Visitor Center"},{"time":"18:00","type":"Transport","text":"Drive to Bayeux — approx. 20 min"},{"time":"19:30","type":"Dinner","text":"Dinner at Le Lion d'Or","restaurant":"Le Lion d'Or"},{"time":"21:30","type":"Hotel","text":"Check in to Normandy lodging (Bayeux area)","hotel":"Normandy VRBO or boutique hotel (traveler to book)"}]},{"day":9,"label":"Day 9 · Tue Oct 20 · Self-Guided Bayeux","city":"Normandy","headline":"The cathedral, the old town, and the largest Commonwealth WWII cemetery in France","stops":[{"time":"09:30","type":"Note","text":"Leisurely morning, hotel breakfast"},{"time":"10:30","type":"Activity","text":"Self-guided walk — Bayeux old town, half-timbered houses and water mills along the Aure river"},{"time":"11:30","type":"Activity","text":"Bayeux Cathedral (Cathédrale Notre-Dame de Bayeux) — self-guided"},{"time":"13:00","type":"Note","text":"Lunch in the town center"},{"time":"14:30","type":"Activity","text":"Musée Mémorial de la Bataille de Normandie (Battle of Normandy Memorial Museum) — self-guided"},{"time":"16:00","type":"Activity","text":"Bayeux War Cemetery — the largest British and Commonwealth WWII cemetery in France — 4,144 Commonwealth graves plus roughly 500 more of other nationalities (mostly German), 4,648 burials in total, directly across the road from the museum"},{"time":"19:30","type":"Dinner","text":"Dinner at L'Angle Saint Laurent","restaurant":"L'Angle Saint Laurent"}]},{"day":10,"label":"Day 10 · Wed Oct 21 · Mont-Saint-Michel","city":"Normandy","headline":"The tidal abbey — a day trip from Bayeux","stops":[{"time":"08:30","type":"Transport","text":"Drive Bayeux to Mont-Saint-Michel — approx. 1h25m (76 miles)"},{"time":"10:00","type":"Activity","text":"Mont-Saint-Michel village — self-guided walk up the Grande Rue to the abbey entrance"},{"time":"12:30","type":"Note","text":"Lunch in the village, or bring a picnic for the mainland dike viewpoint — village restaurants are priced for the tourist crush"},{"time":"14:00","type":"Activity","text":"Abbey interior and ramparts — self-guided, audio guide available on-site"},{"time":"16:30","type":"Transport","text":"Drive back to Bayeux — approx. 1h25m"},{"time":"19:30","type":"Dinner","text":"Dinner at Le Lion d'Or","restaurant":"Le Lion d'Or"},{"time":"22:00","type":"Hotel","text":"Overnight — last Normandy night","hotel":"Normandy VRBO or boutique hotel (traveler to book)"}]},{"day":11,"label":"Day 11 · Thu Oct 22 · Fly to Porto","city":"Porto","headline":"Drive to Paris, fly south to port wine country","stops":[{"time":"08:00","type":"Hotel","text":"Check out of Normandy lodging"},{"time":"08:30","type":"Transport","text":"Private driver to Paris CDG — approx. 2h45m via A13"},{"time":"13:00","type":"Flight","text":"Fly Paris CDG to Porto (CDG -> OPO) — nonstop"},{"time":"15:35","type":"Transport","text":"Private driver from Porto Airport (OPO) to VRBO — 30 min via A20"},{"time":"16:05","type":"Hotel","text":"Check in to Porto VRBO rental","hotel":"Porto VRBO rental"},{"time":"17:00","type":"Activity","text":"Explore the Ribeira waterfront and Ponte Luis I — walk at your own pace"},{"time":"19:30","type":"Dinner","text":"Dinner at Cantinho do Avillez","restaurant":"Cantinho do Avillez"}]},{"day":12,"label":"Day 12 · Fri Oct 23 · Port Cellars & Azulejo Art","city":"Porto","headline":"Morning port tasting at Graham's Lodge, afternoon at São Bento Station","stops":[{"time":"10:00","type":"Activity","text":"Port tasting at Graham's Lodge — cellar tour & vintage tasting"},{"time":"13:00","type":"Lunch","text":"Lunch at Antunes","restaurant":"Antunes"},{"time":"15:30","type":"Activity","text":"São Bento Station azulejo panels — 20,000 hand-painted tiles depicting Portuguese history"},{"time":"20:00","type":"Dinner","text":"Dinner at Pedro Lemos","restaurant":"Pedro Lemos"}]},{"day":13,"label":"Day 13 · Sat Oct 24 · Douro Valley Wine Country","city":"Porto","headline":"Private Douro valley day — Quinta do Vallado tasting & river lunch","stops":[{"time":"08:30","type":"Transport","text":"Private driver pickup for Douro valley day — 2h drive to Peso da Regua via A4"},{"time":"10:30","type":"Activity","text":"Quinta do Vallado — cellar tour, vineyard walk, and premium tasting"},{"time":"13:00","type":"Lunch","text":"Lunch at DOC Restaurant","restaurant":"DOC"},{"time":"15:30","type":"Transport","text":"Return drive to Porto — 2h via N222 scenic river road"},{"time":"19:30","type":"Dinner","text":"Dinner at O Paparico","restaurant":"O Paparico"}]},{"day":14,"label":"Day 14 · Sun Oct 25 · Bookshop, Clerigos Tower & Farewell Dinner","city":"Porto","headline":"Climb Clérigos Tower at sunset for the city's best panorama","stops":[{"time":"10:30","type":"Activity","text":"Livraria Lello — the bookshop long rumored to have inspired Hogwarts library"},{"time":"13:00","type":"Lunch","text":"Lunch at Cafe Santiago","restaurant":"Cafe Santiago"},{"time":"17:30","type":"Activity","text":"Clérigos Tower — climb 225 steps for sunset panorama over Porto"},{"time":"20:00","type":"Dinner","text":"Farewell dinner at The Yeatman","restaurant":"The Yeatman"}]},{"day":15,"label":"Day 15 · Mon Oct 26 · Depart Porto for Newark","city":"Porto","headline":"Morning coffee in Ribeira, then home","stops":[{"time":"09:30","type":"Hotel","text":"Check out of Porto VRBO","hotel":"Porto VRBO rental"},{"time":"10:00","type":"Transport","text":"Private driver from VRBO to Porto Airport (OPO) — 30 min via A20"},{"time":"12:35","type":"Flight","text":"Fly Porto -> Newark nonstop"}]}]}`;
